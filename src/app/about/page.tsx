  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-black text-[var(--foreground)] font-sans fade-in">
      ...
      <main className="w-full max-w-3xl px-4 py-8 flex flex-col gap-8">
        <section>
          <h2 className="text-xl font-semibold mb-2" style={{ color: 'var(--accent)' }}>Nossa História</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-2" style={{ color: 'var(--accent)' }}>Missão & Valores</h2>
          <ul className="list-disc pl-6 text-base text-neutral-200">
